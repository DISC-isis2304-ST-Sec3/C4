...
@Repository
public interface RepositorioReq9 extends JpaRepository<ConsumosUsuario, Long> {
  @Query(
  ...
  List<ConsumosUsuario> ejecutarRequerimiento9(@Param("servicio") String servicio, @Param("date1") Date date1, @Param("date2") Date date2);
}
